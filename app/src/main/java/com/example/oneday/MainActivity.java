...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        manager = new CardStackLayoutManager(this, new CardStackListener() {
            ...
            public void onCardAppeared(View view, int position) {
                TextView tv = view.findViewById(R.id.name_item);
    ...
    private List<ItemModel> addList() {
        ...
        items.add(new ItemModel(R.drawable.one, "Markonah", "24", "Jember"));
        items.add(new ItemModel(R.drawable.two, "Marpuah", "20", "Malang"));
        items.add(new ItemModel(R.drawable.three, "Sukijah", "27", "Jonggol"));
